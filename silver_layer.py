...
# Pure transforms live in transforms.py so they can be unit-tested. This
# notebook cannot be imported by a test - its final cells run the pipeline -
# so the logic worth testing is kept outside it.
...
def process_orders(
    ...
    try:
        ...
        final_df = finalize_orders(deduplicate_orders(valid_df))
